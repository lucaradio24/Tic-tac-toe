...
const GameController = (function () {
  ...
  const getGameState = function () {
    ...
    return { board, current, movesCount, lastResult }; // ritorna un oggetto con tutte le informazioni
  };
...
const p1 = createPlayer("Luca", "X"); // crea il giocatore X
const p2 = createPlayer("Giorgia", "O"); // crea il giocatore O
GameController.init(p1, p2); // inizializza il gioco con i due giocatori
GameController.getGameState(); // ottiene lo stato iniziale del gioco
